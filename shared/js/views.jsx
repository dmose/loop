      ...
      return (
        <div className="settings-menu dropdown">
          ...
          <ul className={cx({
            ...
            <SettingsDropdownEntry displayed={displayChangeRoomName}
            ...
            <SettingsDropdownEntry label={mozL10n.get("settings_menu_item_starttour")}
                                   onClick={this.openGettingStartedTour} />
            <SettingsDropdownEntry label={mozL10n.get("settings_menu_item_feedback")}
                                   onClick={this.handleSubmitFeedback}
                                   ref="item-feedback" />
            <SettingsDropdownEntry label={mozL10n.get(accountAuthLabel)}
                                   onClick={this.handleClickAuthEntry}
                                   ref="item-signin" />
            <SettingsDropdownEntry label={mozL10n.get("settings_menu_item_help")}
